...
* **Job Opportunities:** These data comes from the 2018 LODES (LEHD Origin-Destination Employment Statistics) data, which is prepared in the [Conveyal application](https://docs.conveyal.com/prepare-inputs/upload-spatial-data#lodes-dataset-import). Analyses use the total jobs reported in the LODES dataset.
